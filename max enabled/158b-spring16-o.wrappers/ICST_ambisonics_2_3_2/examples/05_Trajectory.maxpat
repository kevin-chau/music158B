...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 819.365356, 43.214561, 101.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 794.365356, 43.214561, 24.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 794.365356, 74.214561, 54.0, 23.0 ],
					"style" : "",
					"text" : "loop $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 918.0, 205.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 872.286804, 98.0, 35.0, 21.0 ],
					"style" : "",
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 672.0, 637.0, 82.0, 21.0 ],
					"style" : "",
					"text" : "send~ sound1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 203.474655, 597.264343, 281.52533, 21.0 ],
					"style" : "",
					"text" : "aed 1 -26.565042 9.668483 0.567072 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 423.0, 623.0, 62.0, 21.0 ],
					"style" : "",
					"text" : "send pos1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 923.0, 326.0, 79.0, 21.0 ],
					"style" : "",
					"text" : "loadmess 30."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 923.0, 349.0, 43.0, 21.0 ],
					"style" : "",
					"triscale" : 0.9,
					"varname" : "position[5]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1074.0, 415.0, 50.0, 21.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1074.0, 437.168579, 48.0, 21.0 ],
					"style" : "",
					"text" : "gain $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 784.110901, 125.620689, 54.0, 21.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 784.110901, 151.91954, 150.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 853.892273, 317.383148, 48.0, 21.0 ],
					"style" : "",
					"text" : "route 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 853.892273, 294.371643, 57.0, 21.0 ],
					"style" : "",
					"text" : "route aed"
				}
...
,
					"patching_rect" : [ 784.110901, 373.268188, 158.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 735.117188, 596.168579, 32.0, 21.0 ],
					"style" : "",
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 656.499451, 596.168579, 75.0, 21.0 ],
					"style" : "",
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 8,
					"numoutlets" : 0,
					"patching_rect" : [ 784.110901, 619.180054, 276.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 784.110901, 468.601532, 277.0, 21.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 784.110901, 173.835251, 49.0, 21.0 ],
					"saved_object_attributes" : 					{
						"basictuning" : 440,
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
						"mode" : "basic",
						"originallength" : [ 15383.640816, "ticks" ],
						"originaltempo" : 120.0,
						"pitchcorrection" : 0,
						"quality" : "basic",
						"timestretch" : [ 0 ]
...
,
					"patching_rect" : [ 784.110901, 340.394623, 73.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 11.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 784.110901, 400.662842, 277.5, 21.0 ],
					"saved_object_attributes" : 					{
						"active" : [ 1 ],
						"aed_scale" : 10.0,
						"center_att_db" : 6.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.592407, 356.831421, 92.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.810989, 523.390808, 39.0, 21.0 ],
					"style" : "",
					"text" : "write"
				}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 371.5, 267.0, 388.9, 267.0 ],
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 371.5, 267.0, 274.1, 267.0 ],
									"source" : [ "obj-6", 0 ]
								}
...
,
					"patching_rect" : [ 217.835266, 226.432953, 66.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.835266, 284.509583, 77.0, 21.0 ],
					"style" : "",
					"text" : "fit_trajectory"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 225.810989, 471.888885, 170.0, 21.0 ],
					"saved_object_attributes" : 					{
						"pointsize" : 0.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 441.155212, 53.298851, 54.0, 21.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 441.155212, 75.214561, 68.0, 21.0 ],
					"style" : "",
					"text" : "aed 1 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 458.155212, 62.637939, 250.0, 500.0 ],
					"point_color" : [ 0.996094, 0.996094, 0.996094, 1.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 31.155212, 12.637939, 250.0, 500.0 ],
					"varname" : "spiral"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 218.974655, 137.578537, 142.0, 57.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.532211, 398.471252, 155.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.629349, 76.310349, 81.0, 21.0 ],
					"style" : "",
					"text" : "connect spiral"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 191.629349, 559.551697, 136.0, 21.0 ],
					"saved_object_attributes" : 					{
						"connect" : "spiral",
						"interpolation" : 1,
						"loop" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 467.655212, 526.678162, 741.953552, 526.678162, 741.953552, 396.279694, 793.610901, 396.279694 ],
					"source" : [ "obj-55", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 467.655212, 526.678162, 741.953552, 526.678162, 741.953552, 291.08429, 863.392273, 291.08429 ],
					"source" : [ "obj-55", 0 ]
				}
